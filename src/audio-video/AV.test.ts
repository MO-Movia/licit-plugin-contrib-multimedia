...
import resolveVideo from '../ui/audio-video/ResolveAV';
import axios from 'axios';
import VideoResizeBox from '../ui/audio-video/AVResizeBox';
import VideoNodeView, { VideoViewBody } from '../ui/audio-video/AVNodeView';
...
describe('Video Plugin - Test', () => {
  ...
  const properties: AVEditorProps = {
    initialValue: {},
    close: () => undefined,
    isAudio: false
  };
  ...
  it('should resolve video', async () => {
    const nullsrcState: AVEditorState = {
      id: attrs.id,
      src: '',
      width: attrs.width,
      height: attrs.height,
